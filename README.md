...
|hospital|<li>contains the list of all the entities (**'has-a'**): `doctor, patient, nurse, driver, ambulance, appointment` (stores them in a map with their `id` as the key);<li>all members of this class are static, so, it doesn't require instantiation;|
___
